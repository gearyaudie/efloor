...
export default function FaqSectionJakartaTimur() {
  ...
  return (
    <section
      ...
      id="faq-lem-vinyl-karpet-jakarta-timur"
      aria-label="Pertanyaan yang Sering Diajukan tentang Lem Vinyl dan Lem Karpet di Jakarta Timur"
    >
      ...
      <div className="text-center mb-12">
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-[#1a1a1a] leading-snug">
          Pertanyaan Seputar Lem Vinyl &amp; Lem Karpet EFLOOR di Jakarta Timur
        </h2>
        <p className="mt-4 text-[#808080] text-base md:text-lg max-w-[560px] mx-auto">
          ...
          untuk kebutuhan distributor, pabrik, dan procurement di Jakarta Timur.
        </p>
      </div>
            ...
            >
              <dt>
                <button
                  ...
                  aria-controls={`faq-jakarta-timur-answer-${index}`}
                  id={`faq-jakarta-timur-question-${index}`}
              ...
              <dd
                id={`faq-jakarta-timur-answer-${index}`}
                role="region"
                aria-labelledby={`faq-jakarta-timur-question-${index}`}
