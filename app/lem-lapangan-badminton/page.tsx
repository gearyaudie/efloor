...
export default function LemLapanganBadminton() {
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row items-center gap-10 px-4 my-16 md:my-20 max-w-[1200px] mx-auto">
        <div className="flex-1 flex justify-center">
          <Image
            ...
            alt="Pemasangan lantai vinyl dan karpet lapangan badminton dengan Lem EFLOOR"
            width={1200}
            height={1195}
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="pt-8">
            <WhatsAppButton product="Lem Lapangan Badminton" source="landing-hero">
              Dapatkan Sekarang!
            </WhatsAppButton>
          </div>
        </div>
      ...
      <RelatedVerticals currentHref="/lem-lapangan-badminton" />
